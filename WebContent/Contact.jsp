              ...
              <div class="row">
                ...
                <div class="col-12 mb-3">
                        ...
                        <option value="0">subject</option>
                          <option value="Property is not NA">Property is not NA</option>
                          <option value="incomplete Document" >incomplete Document</option>
                          <option value="Wrong measuring">Wrong measuring</option>
                ...
                <input type="hidden" id="title" name="status" value="In Process">
