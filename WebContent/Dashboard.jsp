    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Propertylist.jsp">
              <i class="mdi mdi-table-large menu-icon"></i>
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hi, welcome ! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Your Property insurance portal</span>
              </h3>
              <div class="d-flex">
            ...
            <div class="row">
              <div class="col-xl-9 col-sm-7 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body px-0 overflow-auto">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                        <%
                       List<User> ls=new Userdao().retrivedata();
                        for(User u : ls){
