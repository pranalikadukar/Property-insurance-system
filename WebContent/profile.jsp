...
<title>Property Insurance Portal</title>
</head>
<body>
...
<div class="site-mobile-menu site-navbar-target">
                ...
                <ul class="dropdown">
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown">
                      ...
                      <li><a href="allquotation.jsp">All Quotation</a></li>
                    </ul>
                  </li>
                </ul>  
              </li>
    ...
    <div class="hero">
      <div class="hero-slide">
        <div
          class="img overlay"
          style="background-image: url('image/hero_bg_3.jpg')"
        ></div>
        <div
          class="img overlay"
          style="background-image: url('image/hero_bg_2.jpg')"
        ></div>
        <div
          class="img overlay"
          style="background-image: url('image/hero_bg_1.jpg')"
        ></div>
      </div>
              ...
              <div class="property-slider">
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="image/img_1.jpg" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="image/img_2.jpg" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="image/img_5.jpg" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="image/img_6.jpg" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="image/img_7.jpg" alt="Image" class="img-fluid" />
                  </a>
                ...
                <div class="property-item">
                  <a href="property-single.html" class="img">
                    <img src="image/img_8.jpg" alt="Image" class="img-fluid" />
                  </a>
        ...
        <div class="row justify-content-between mb-5">
          <div class="col-lg-7 mb-5 mb-lg-0 order-lg-2">
            <div class="img-about dots">
              <img src="image/hero_bg_3.jpg" alt="Image" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-4">
